        ...
        <ul class="flex flex-col pl-0 mb-0">
          ...
          <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="../pages/profiltapsit.php">
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Team Project</span>
            </a>
          </li>
          ...
          <div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
            <div class="border-black/12.5 shadow-soft-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
              <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
                ...
                <p class="leadinttwg-normal text-sm">
              ...
              <div>
                <table border="1" id="dataTable">
                    <tr>
                        ...
                        <th>RFID</th>
                        <th>BATERAI</th>
                        <th>Kondisi meja</th> <!-- Existing column -->
                        <th>Kondisi Baterai</th> <!-- New column header -->
                    </tr>
                </table>
            </div>
                <script>
                      function fetchData() {
                        fetch('kondisimeja.php')
                            ...
                            .then(data => {
                                ...
                                // Variable to hold all tables with low battery
                                let lowBatteryTables = [];

                                data.forEach(row => {
                                    console.log(`Row data: ${row.meja}, Battery: ${row.batt}`); 
                                    const newRow = table.insertRow();
                                    newRow.insertCell(0).innerText = row.meja;
                                    newRow.insertCell(1).innerText = row.rfid;
                                    newRow.insertCell(2).innerText = row.batt;

                                    // Kondisi Meja
                                    const kondisiMejaCell = newRow.insertCell(3);
                                    if (row.rfid === '73389603') {
                                        kondisiMejaCell.innerText = 'Kosong';
                                        kondisiMejaCell.style.backgroundColor = 'green';
                                    } else {
                                        kondisiMejaCell.innerText = 'Used';
                                        kondisiMejaCell.style.backgroundColor = 'red';
                                    }

                                    // Kondisi Baterai
                                    const kondisiBatteryCell = newRow.insertCell(4);
                                    const batteryLevel = parseInt(row.batt, 10);
                                    if (isNaN(batteryLevel)) {
                                        kondisiBatteryCell.innerText = 'Data tidak valid';
                                        kondisiBatteryCell.style.backgroundColor = 'yellow';
                                    } else if (batteryLevel <= 10) {
                                        kondisiBatteryCell.innerText = 'BATT HABIS';
                                        kondisiBatteryCell.style.backgroundColor = 'red';
                                        // Add table to the lowBatteryTables array if battery is below 10
                                        lowBatteryTables.push(`Meja ${row.meja} (Level: ${batteryLevel}%)`);
                                    } else {
                                        kondisiBatteryCell.innerText = ''; // No text if above 10
                                        kondisiBatteryCell.style.backgroundColor = 'green';
                                    }
                                });

                                // If there are any tables with low battery
                    ...
                    // toast notification jika ada baterai hampir habis
                    function addToastStyles() {
                        ...
                        style.innerHTML = `
                            ...
                            #toastContainer {
                                ...
                                padding: 12px 20px;
                                border-radius: 8px;
                                background: linear-gradient(135deg, #ff5f6d, #ffc371); /* Soft gradient background */
                                color: #fff;
                    ...
                    // Panggil fungsi untuk menambahkan style toast
                    addToastStyles();

                    // menampilkan notifikasi toast
                    function showToastNotification(message) {
                        // Periksa apakah container toast sudah ada, jika belum buat yang baru
                        ...
                        // Set konten toast dengan ikon dan pesan peringatan
                        ...
                        // Tampilkan toast container dengan animasi
                        toastContainer.style.display = 'block';
                        // Sembunyikan toast setelah 5 detik
                        setTimeout(() => {
                            toastContainer.style.display = 'none';
                        }, 10000); // Durasi notifikasi
                    }
            ...
            <div class="flex flex-wrap items-center -mx-3 lg:justify-between">
              <div class="w-full max-w-full px-3 mt-0 mb-6 shrink-0 lg:mb-0 lg:w-1/2 lg:flex-none">
                <div class="leading-normal text-center text-sm text-slate-500 lg:text-left">
                  ...
                  <a href="https://www.creative-tim.com" class="font-semibold text-slate-700" target="_blank">TapSit Tim</a>
                  for a better web.
                </div>
              </div>
